...
GPIO.setup(LED_40, GPIO.IN)
status = GPIO.input(LED_40)
...
def led_indication():
    ...
    GPIO.setup(LED_40,GPIO.OUT)             # initialize digital pin40 as an output.
    GPIO.output(LED_40,True)
